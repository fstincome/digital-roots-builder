...
const WeatherWidget = () => {
  ...
  return (
    <div
      className="fixed bottom-6 right-24 sm:right-36 z-50 flex items-center gap-2 bg-card/90 backdrop-blur border border-border px-4 py-3 rounded-full shadow-lg"
