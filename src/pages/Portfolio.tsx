    ...
    <section className="pt-32 pb-20">
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <span className="font-mono text-xs text-primary tracking-widest uppercase">{t("portfolio.tag")}</span>
          <h1 className="text-4xl md:text-5xl font-semibold text-foreground mt-3 mb-4">{t("portfolio.title")}</h1>
          <p className="text-lg text-muted-foreground max-w-xl">{t("portfolio.desc")}</p>
        </motion.div>
